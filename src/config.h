...
#define PROGRAM_STACK_SIZE_BYTES (16 * 1024) // 16 KB
#define PROGRAM_STACK_TOP_ADDRESS 0x3FF000 // Just below 4 MB
#define PROGRAM_STACK_BOTTOM_ADDRESS (PROGRAM_STACK_TOP_ADDRESS - PROGRAM_STACK_SIZE_BYTES)
